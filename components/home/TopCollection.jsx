	...
	return (
		<section className="container py-[8.375rem] flex justify-between">
			...
			<div>
				...
				<div className="mt-8">
					<div className="w-[19.5625rem] flex items-center space-x-[1.375rem]">
						...
						<div>
							...
							<div className="flex items-center text-sm font-semibold -tracking-wide text-[#636363] mt-2.5">
								<EthereumIcon className="mr-[0.3987rem] text-black" /> 19,769.39
							</div>
						</div>
						<div className="text-[#14C8B0] font-semibold text-xl">+26.52%</div>
					</div>
				</div>
			</div>
		</section>
